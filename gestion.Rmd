...
WORDS_TO_IGNORE <- c(
  "and", "to", "Bend", "Breakdancer", "Cat", "Cow", "Dog", "Downward", 
  "Facing", "Forward", "GOWOD", "Hamstring", "Hamstrings", "Hip", "Piriformis", 
  "Prayer", "Quad", "Rack", "Sagittarius", "Sit", "Supine", "The", "Turtle", 
  "Wall", "External", "Lunges", "Thread", "Needle", "Rainbow", "Ballerina", 
  "Opener", "Side", "Through")
...
- Dans la bibliothèque de plus de 300 exercices de mobilité et d'étirements, cherchez et essayer ceux que je pratique actuellement :
    ...
    - The Sagittarius
    - 90 To 90 Hip External Rotations
    
- Quand vous avez un peu de temps (même 5 minutes), faîtes quelques-uns de ces exercices
