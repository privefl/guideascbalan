...
<div style='
      ...
      text-align: center;
      vertical-align: top;
    '><img src='trombi/Axel_Dumoulin.png' style='width:100%; max-width:95px; border-radius:8px;'><br><div style='height:70px; overflow:hidden; line-height:1.3em; font-size: 0.9em;'><strong>Axel</strong><br>Dumoulin</div></div>
<div style='
      flex: 1 1 85px;
      height: 190px;
      margin: 5px;
