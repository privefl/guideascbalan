...
Pour aller plus loin sur l'endurance fondamentale, regardez [cette vidéo](https://www.youtube.com/watch?v=Ef6HfDqHZIg).

L'endurance fondamentale est souvent qualifiée de "lente" ou même "inutile" car elle est réalisée à une intensité souvent jugée trop basse, représentant environ 60 à 75 % de la FCM.
...
- Le corps est capable de puiser efficacement dans les réserves de graisses pour produire de l'énergie (au lieu d'utiliser les réserves limitées de glycogène),
...
**L'endurance fondamentale (EF) est lente par conception**, car cette allure permet d'entraîner le système aérobie de manière optimale,
...
Inversement, on pourrait utiliser certaines performances en compétition pour estimer sa VMA.
...
Pour une sortie longue, la distance maximale recommandée dépend du volume hebdomadaire total, car elle doit rester proportionnelle pour éviter le surmenage et les blessures.
Une règle fréquemment utilisée par les entraîneurs est que la sortie longue ne dépasse pas 30 à 35 % du volume hebdomadaire total (en kilomètres). Cela peut varier selon les objectifs (10 km, semi, marathon) et le niveau du coureur.
