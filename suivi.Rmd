...
- "signup for free" -> renseignez la fréquence cardiaque max à ce moment-là. Pour estimer votre fréquence cardiaque maximale avec une montre, relevez la valeur la plus élevée observée lors d'efforts très intenses. Comme la plupart des personnes ne parviennent pas à se donner à 100 % en dehors d'un test spécifique, ajoutez environ 2 bpm pour obtenir une estimation plus proche de votre FCmax réelle.

- connectez les activités avec votre montre et/ou Strava (dans le menu Paramètres, onglet connexion), puis cliquez sur "Téléchargez d'anciennes données". A noter que j'ai récemment déconnecté Strava car les laps communiqués à intervals ne correspondaient pas toujours aux laps réels.
