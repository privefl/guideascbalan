...
WORDS_TO_IGNORE <- c("d'EF", "allureCourse", "allureVMA", "WhatsApp")
...
La sortie longue est une séance clé pour ceux qui préparent des courses de longue distance (semi-marathon, marathon, trail).
...
Pour aller plus loin sur la sortie longue, regardez [cette vidéo](https://youtu.be/JFww4nEjej4) et [cette vidéo](https://youtu.be/dsT1qLCp1P4).
...
Une règle fréquemment utilisée par les entraîneurs est que la sortie longue ne dépasse pas 30 à 35 % (un tiers) du volume hebdomadaire total (en kilomètres). Il faut aussi ne pas augmenter sa durée de plus de 15 min par semaine (progressivité), et ne pas hésiter à repartir d'une sortie longue plutôt courte (comme 45 minutes) après une coupure pendant laquelle on a beaucoup réduit le volume.

Elle se pratique généralement pendant le week-end. Il y a des groupes du club qui courent régulièrement le week-end.
