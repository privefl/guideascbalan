...
WORDS_TO_IGNORE <- c("médio-pied", "running", "supinatrice", "Ambérieu", "i-run")
...
habitués aux faibles drops. À utiliser avec précaution et très progressivement pour éviter les blessures.
