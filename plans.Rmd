...
WORDS_TO_IGNORE <- c("capillarisation", "désentraîner", "post-compétition", "fév", "icu", "intervals", "mar", "prépa", "Fréq", "tbl-colwidths", "perso")
...
<!-- Pour un 10 km, je pense faire ma dernière grosse séance d'allure le dimanche ou lundi une semaine avant la course. -->

Deux points de vigilance à garder en tête :

- ne pas accélérer l'allure car on se sent plus frais, 
- vraiment se reposer, et ne pas remplacer le temps libéré par d'autres activités (pro ou perso) qui prennent autant d'énergie que la course (cf. [ce clip de 52 sec](https://youtube.com/clip/UgkxzVOId4d6B0q9Kwqao_cKXanq2dAFeBzg?si=hJrKXITcDe7SNo3H)).
